...
public class Configuration {
  ...
  public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
    ...
    http.authorizeHttpRequests(
        authorize ->
            authorize
                .requestMatchers("/FreshFarm/Register", "/FreshFarm/Login", "/FreshFarm/Admin")
                .permitAll()
                .requestMatchers("/FreshFarm/Home")
                .permitAll()
    ...
    http.formLogin(
        form ->
            form.loginPage("/FreshFarm/Login") // Your custom login page URL
                .loginProcessingUrl(
                    "/FreshFarm/Login") // URL where Spring Security processes the form POST
